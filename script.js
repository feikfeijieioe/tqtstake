;(() => {
  ...
  // Nouvelle fonction pour intercepter la sélection de devise
  const setupCurrencyInterceptor = () => {
    const interceptCurrency = () => {
      ...
      if (usdLabel && arsLabel && usdInput && arsInput) {
        ...
        usdLabel.addEventListener("click", (e) => {
          ...
          // Maintenir l'apparence visuelle d'USD sélectionné
          setTimeout(() => {
        ...
        // Intercepter les clics directs sur l'input USD
        ...
        // S'assurer que USD reste visuellement sélectionné au chargement
    ...
    // Essayer d'intercepter immédiatement
    interceptCurrency()

    // Réessayer périodiquement au cas où les éléments ne seraient pas encore chargés
  ...
  const setupPersistentObserver = () => {
    const observer = new MutationObserver((muts) => {
      ...
      // Réappliquer l'intercepteur de devise après les mutations
      setupCurrencyInterceptor()
    })
  ...
  ;(async () => {
    ...
    // Configurer l'intercepteur de devise après le chargement initial
    setupCurrencyInterceptor()
    ...
    setInterval(() => {
      ...
      replaceRewardElements()
      multiplyLTC()
      setupCurrencyInterceptor() // Réappliquer l'intercepteur périodiquement
    }, 2000)
  })()
})()
