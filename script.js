(() => {
  ...
  const WAGERED_SELECTOR = 'div.card.svelte-1u84h7c span.weight-bold.line-height-default.align-left.size-md.text-size-md.variant-highlighted.numeric.svelte-1f6lug3';
