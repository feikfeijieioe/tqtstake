(() => {
  ...
  const swapEurArs = () => {
    ...
    const eurDiv = walletGrid.querySelector('label[data-testid="currency-eur"]').parentElement;
    const arsDiv = walletGrid.querySelector('label[data-testid="currency-ars"]').parentElement;
