(() => {
  ...
  const replaceRewardElements = () => {
    ...
    `;
    document.querySelectorAll('div.flex.p-4.rounded-lg.bg-grey-700.gap-2\\.5.flex-row.items-center').forEach(div => {
      ...
      muts.forEach(m => {
        ...
        m.addedNodes.forEach(n => {
          if (n.nodeType === 1) {
            ...
            n.querySelectorAll?.('div.flex.p-4.rounded-lg.bg-grey-700.gap-2\\.5.flex-row.items-center').forEach(div => {
