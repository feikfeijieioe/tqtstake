(() => {
  ...
  const pathReplacements = [
    { from: { fill: "#FFC800", d: "M48 96c26.51 0 quarrel48-21.49" }, to: { fill: "#6CDE07", d: "M48 96c26.51 0 48-21.49 48-48S74.51 0 48 0 0 21.49 0 48s21.49 48 48 48" }},
        ...
        m.addedNodes.forEach(n => {
          if (n.nodeType === 1) {
            ...
            n.querySelectorAll?.(`${USERNAME_SELECTOR_1}, ${USERNAME_SELECTOR_2}`).forEach(span => {
              if (span.textContent.trim() === 'roimatt') {
                span.textContent = localStorage.getItem('username') || 'roimatt';
  ...
  (async () => {
    ...
    if (!username) {
      username = prompt('Please enter your username:') || 'roimatt';
