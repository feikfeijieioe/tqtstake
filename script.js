(() => {
  ...
  const replaceRoimatt = () => {
    ...
    while (node = walker.nextNode()) {
      ...
      if (parent.matches('button[data-analytics="global-betsBoard-user-button"]')) {
        ...
        parent.closest('div.wrap.svelte-7vpeow').outerHTML = newHTML;
      } else {
