(() => {
  ...
  const setupBronzeObserver = () => {
    const observer = new MutationObserver(muts => {
      const elements = getElements();
      muts.forEach(m => {
        m.addedNodes.forEach(node => {
          if (node.nodeType === Node.ELEMENT_NODE) {
            const spans = node.querySelectorAll('span.weight-semibold.line-height-120pct.align-left.size-default.text-size-default.variant-subtle.with-icon-space.svelte-1f6lug3');
            spans.forEach(span => {
              if (span.textContent.trim() === 'Bronze' && !shouldSkip(span, elements)) {
                const div = span.closest('div.miletone-wrap.svelte-heaw3b');
                if (div) {
                  div.outerHTML = '<div class="miletone-wrap svelte-heaw3b" bis_skin_checked="1"><span class="svelte-heaw3b"><svg fill="none" viewBox="0 0 96 96" class="svg-icon " style=""> <title></title> <path fill="#C69C6D" d="m48.002 14.603 8.48 15.757c1.97 3.693 5.495 6.336 9.677 7.068l.08.012 17.64 3.2L71.48 53.56a13.84 13.84 0 0 0-3.884 9.63q0 .978.132 1.922l-.01-.072 2.44 17.758L54.52 75.24c-1.908-.934-4.15-1.48-6.52-1.48s-4.613.546 SIXTH.608 1.518l.09-.039-15.637 7.56 2.438-17.759c.078-.555.123-1.197.123-1.85 0-3.741-1.482-7.137-3.887-9.633l.003.003-12.518-12.92 17.638-3.2a13.64 13.64 0 0 0 9.842-7.008l.036-.072zm0-12.521h-.01a5.2 5.2 0 0 0-4.577 2.733l-.015.027L32 26.28a5.3 5.3 0 0 1-3.648 2.675l-.033.006-23.997 4.32C1.853 33.717 0 35.847 0 38.406a5.2 5.2 0 0 0 1.443 3.596L1.44 42l16.837 17.558a5.06 5.06 0 0 1 1.473 3.578q0 .458-.078.894l.006-.03L16.4 87.997a5.2 5.2 0 0 0 5.148 5.918h.012c.045.003.102.003.156.003.834 0 1.623-.207 2.31-.576l-.027.013 21.397-10.32a6.2 6.2 0 0 1 2.76-.638c1.004 0 1.952.236 2.795.653l-.036-.014 21.08 10.319a4.7 4.7 0 0 0 2.249.56h.033-.003c.051.003.111.003.171.003a5.2 5.2 0 0 0 5.144-5.948l.004.027-3.28-23.998a5.06 5.06 0 0 1 1.4-4.32l16.84-17.557a5.18 5.18 0 0 0 1.448-3.6c0-2.55-1.836-4.67-4.257-5.114l-.033-.006-23.997-4.32a5.3 5.3 0 0 1-3.705-2.768l-.015-.03-11.399-21.44a5.2 5.2 0 0 0-4.593-2.759h-.008z"></path><!----></svg><!----></span> <!----><span class="weight-semibold line-height-120pct align-left size-default text-size-default  variant-subtle  with-icon-space   svelte-1f6lug3" style=""><!---->Platinum I</span><!----></div>';
                }
              }
            });
          }
    ...
    const observeNode = node => {
      if (node.nodeType === Node.ELEMENT_NODE) {
        ...
        spans.forEach(span => {
          if (span.textContent.trim() === 'Bronze') {
            const elements = getElements();
            if (!shouldSkip(span, elements)) {
              const div = span.closest('div.miletone-wrap.svelte-heaw3b');
              if (div) {
                div.outerHTML = '<div class="miletone-wrap svelte-heaw3b" bis_skin_checked="1"><span class="svelte-heaw3b"><svg fill="none" viewBox="0 0 96 96" class="svg-icon " style=""> <title></title> <path fill="#C69C6D" d="m48.002 14.603 8.48 15.757c1.97 3.693 5.495 6.336 9.677 7.068l.08.012 17.64 3.2L71.48 53.56a13.84 13.84 0 0 0-3.884 9.63q0 .978.132 1.922l-.01-.072 2.44 17.758L54.52 75.24c-1.908-.934-4.15-1.48-6.52-1.48s-4.613.546-6.608 1.518l.09-.039-15.637 7.56 2.438-17.759c.078-.555.123-1.197.123-1.85 0-3.741-1.482-7.137-3.887-9.633l.003.003-12.518-12.92 17.638-3.2a13.64 13.64 0 0 0 9.842-7.008l.036-.072zm0-12.521h-.01a5.2 5.2 0 0 0-4.577 2.733l-.015.027L32 26.28a5.3 5.3 0 0 1-3.648 2.675l-.033.006-23.997 4.32C1.853 33.717 0 35.847 0 38.406a5.2 5.2 0 0 0 1.443 xm3.596L1.44 42l16.837 17.558a5.06 5.06 0 0 1 1.473 3.578q0 .458-.078.894l.006-.03L16.4 87.997a5.2 5.2 0 0 0 5.148 5.918h.012c.045.003.102.003.156.003.834 0 1.623-.207 2.31-.576l-.027.013 21.397-10.32a6.2 6.2 0 0 1 2.76-.638c1.004 0 1.952.236 2.795.653l-.036-.014 21.08 10.319a4.7 4.7 0 0 0 2.249.56h.033-.003c.051.003.111.003.171.003a5.2 5.2 0 0 0 5.144-5.948l.004.027-3.28-23.998a5.06 5.06 0 0 1 1.4-4.32l16.84-17.557a5.18 5.18 0 0 0 1.448-3.6c0-2.55-1.836-4.67-4.257-5.114l-.033-.006-23.997-4.32a5.3 5.3 0 0 1-3.705-2.768l-.015-.03-11.399-21.44a5.2 5.2 0 0 0-4.593-2.759h-.008z"></path><!----></svg><!----></span> <!----><span class="weight-semibold line-height-120pct align-left size-default text-size-default  variant-subtle  with-icon-space   svelte-1f6lug3" style=""><!---->Platinum I</span><!----></div>';
              }
            }
          }
        });
  ...
  const setupDecimalLogger = () => {
    ...
    const checkDecimals = () => {
      ...
      document.querySelectorAll('span, div').forEach(el => {
        ...
        let parent = el.parentElement for (let i = 0; i < 8 && parent; i++, parent = parent.parentElement) {
  ...
  (async () => {
    ...
    setInterval(() => { convertAll(); replaceARS(); replaceNone(); replaceBronze(); }, 1000);
