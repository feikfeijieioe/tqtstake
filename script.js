(() => {
  ...
  const transformRakebackToMonthlyBonus = () => {
    console.log(' transformRakebackToMonthlyBonus en cours');
    const targetDivs = document.querySelectorAll('div.flex.flex-col.p-4.rounded-lg.bg-grey-700.gap-2\\.5');
    targetDivs.forEach(div => {
      // Update outer div attributes
      div.classList.remove('p-4', 'gap-2.5');
      div.setAttribute('data-state', 'closed');
      div.setAttribute('data-melt-collapsible', '');
      div.setAttribute('data-collapsible-root', '');

      // Find the inner div to replace with button
      const innerDiv = div.querySelector('div.flex.w-full.justify-between.items-center.gap-4');
      if (innerDiv) {
        const button = document.createElement('button');
        button.setAttribute('data-state', 'closed');
        button.setAttribute('data-melt-collapsible-trigger', '');
        button.setAttribute('data-collapsible-trigger', '');
        button.setAttribute('type', 'button');
        button.setAttribute('data-analytics', 'vip-reward-description-monthly-boost-open');
        button.className = 'flex w-full justify-between items-center gap-4 transition-all [&[data-state=open]>svg]:rotate-180 p-4';
        
        // Move inner div's children to button
        while (innerDiv.firstChild) {
          button.appendChild(innerDiv.firstChild);
        }
        innerDiv.replaceWith(button);

        // Update the first SVG
        const svg = button.querySelector('svg[width="55"][height="64"]');
        if (svg) {
          svg.innerHTML = `
            ...
            <defs>
              <linearGradient id="paint0_linear_16329_1249" x1="27.5" y1="74.8752" x2="27.5" y2="11.6226" gradientUnits="userSpaceOnUse"><stop stop-color="#213743"></stop><stop offset="1" stop-color="#2F4653"></stop></linearGradient>
              <linearGradient id="paint1_linear_16329_1249" x1="27.4992" y1="-14.8364" x2="27.4992" y2="91.8152" gradientUnits="userSpaceOnUse"><stop stop-color="#0A1D29"></stop><stop offset="1" stop-color="#213745"></stop></linearGradient>
              <linearGradient id="paint2_linear_16329_1249" x1="21.1806" y1="25.1442" x2="21.1806" y2="14.0658" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBB62"></stop><stop offset="1" stop-color="#E27837"></stop></linearGradient>
              <linearGradient id="paint3_linear_16329_1249" x1="33.7802" y1="25.1442" x2="33.7802" y2="14.0658" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBB62"></stop><stop offset="1" stop-color="#E27837"></stop></linearGradient>
              <linearGradient id="paint4_linear_16329_1249" x1="27.5001" y1="-19.1418" x2="27.5001" y2="50.7661" gradientUnits="userSpaceOnUse"><stop stop-color="#213743"></stop><stop offset="1" stop-color="#2F4653"></stop></linearGradient>
              <linearGradient id="paint5_linear_16329_1249" x1="27.4996" y1="-33.5176" x2="27.4996" y2="47.1471" gradientUnits="userSpaceOnUse"><stop stop-color="#213743"></stop><stop offset="1" stop-color="#2F4653"></stop></linearGradient>
              <linearGradient id="paint6_linear_16329_1249" x1="27.5192" y1="21.5511" x2="27.5192" y2="64.9068" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBB62"></stop><stop offset="1" stop-color="#E27837"></stop></linearGradient>
              <linearGradient id="paint7_linear_16329_1249" x1="27.4991" y1="19.5436" x2="27.4991" y2="56.6037" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBB62"></stop><stop offset="1" stop-color="#E27837"></stop></linearGradient>
              <linearGradient id="paint8_linear_16329_1249" x1="27.4991" y1="29.5292" x2="27.4991" y2="48.1932" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBB62"></stop><stop offset="1" stop-color="#E27837"></stop></linearGradient>
              <linearGradient id="paint9_linear_16329_1249" x1="27.4997" y1="47.1471" x2="27.4997" y2="28.9759" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBB62"></stop><stop offset="1" stop-color="#E27837"></stop></linearGradient>
            </defs>
          `;
          console.log('Updated SVG in Rakeback section');
        }

        // Update text content
        const h2 = button.querySelector('h2.weight-bold.line-height-120pct.align-left.size-md.text-size-md');
        if (h2) {
          h2.textContent = 'Monthly Bonus';
          h2.classList.remove('variant-subtle');
          h2.classList.add('variant-highlighted');
          console.log('Updated h2 to Monthly Bonus');
        }

        const span = button.querySelector('span.weight-normal.line-height-120pct.align-left.size-default.text-size-default');
        if (span) {
          span.textContent = 'Released once a month.';
          console.log('Updated span text to Released once a month.');
        }

        // Update the second SVG (lock to chevron)
        const lockSvg = button.querySelector('svg.w-4.h-4');
        if (lockSvg) {
          lockSvg.innerHTML = '<path d="M32.274 49.762 9.204 26.69l6.928-6.93 16.145 16.145L48.42 19.762l6.93 6.929-23.072 23.07z"></path>';
          lockSvg.classList.add('transition-all', 'duration-50');
          console.log('Replaced lock SVG with chevron SVG');
        }
      }

      console.log('Transformed Rakeback to Monthly Bonus section');
    });
  };
  ...
  const setupPersistentObserver = () => {
    ...
    const observer = new MutationObserver(muts => {
      ...
      muts.forEach(m => {
        ...
        m.addedNodes.forEach(n => {
          if (n.nodeType === 1) {
            ...
            n.querySelectorAll?.('div.flex.flex-col.p-4.rounded-lg.bg-grey-700.gap-2\\.5').forEach(div => transformRakebackToMonthlyBonus());
      ...
      transformRakebackToMonthlyBonus();
      if (ltcChanged) {
        multiplyLTC();
